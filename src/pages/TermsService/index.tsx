    ...
    return (
        <>
            ...
            <div className="inner-page lg:py-[80px] pt-12 pb-[270px] md:pb-[310px]">
                <Container>
                    <h2 className="text-black text-[29px] md:text-[32px] lg:text-[42px] font-frank">Terms and Conditions</h2>
                    ...
                    <h2 className="text-black text-[29px] md:text-[32px] lg:text-[42px] font-frank mt-3">Interpretation and Definitions</h2>
                    ...
                    <h2 className="text-black text-[29px] md:text-[32px] lg:text-[42px] font-frank mt-3">Acknowledgment</h2>
                    ...
                    <h2 className="text-black text-[29px] md:text-[32px] lg:text-[42px] font-frank mt-3">Links to Other Websites</h2>
                    ...
                    <h2 className="text-black text-[29px] md:text-[32px] lg:text-[42px] font-frank mt-3">Termination</h2>
                    ...
                    <h2 className="text-black text-[29px] md:text-[32px] lg:text-[42px] font-frank mt-3">Limitation of Liability</h2>
                    ...
                    <h2 className="text-black text-[29px] md:text-[32px] lg:text-[42px] font-frank mt-3">"AS IS" and "AS AVAILABLE" Disclaimer</h2>
                    ...
                    <h2 className="text-black text-[29px] md:text-[32px] lg:text-[42px] font-frank mt-3">Governing Law</h2>
                    ...
                    <h2 className="text-black text-[29px] md:text-[32px] lg:text-[42px] font-frank mt-3">Disputes Resolution</h2>
                    ...
                    <h2 className="text-black text-[29px] md:text-[32px] lg:text-[42px] font-frank mt-3">For European Union (EU) Users</h2>
                    ...
                    <h2 className="text-black text-[29px] md:text-[32px] lg:text-[42px] font-frank mt-3">United States Legal Compliance</h2>
                    ...
                    <h2 className="text-black text-[29px] md:text-[32px] lg:text-[42px] font-frank mt-3">Severability and Waiver</h2>
                    ...
                    <h2 className="text-black text-[29px] md:text-[32px] lg:text-[42px] font-frank mt-3">Translation Interpretation</h2>
                    ...
                    <h2 className="text-black text-[29px] md:text-[32px] lg:text-[42px] font-frank mt-3">Changes to These Terms and Conditions</h2>
                    ...
                    <h2 className="text-black text-[29px] md:text-[32px] lg:text-[42px] font-frank mt-3">Contact Us</h2>
