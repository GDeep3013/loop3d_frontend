...
const Contact: React.FC = () => {
    ...
    return (
        <>
                ...
                <Container>
                    ...
                    <div className="contact-form flex flex-col md:flex-row max-w-full md:max-w-[1070px] m-auto mt-[40px] md:mt-[67px] px-4 md:px-0">
                        <div className="w-full md:w-1/2 md:pr-24">
                            ...
                            <Link to="tel:747-200-7091" className="w-full md:text-xl text-lg font-poppins flex mt-[30px] md:mt-[60px]">
                                <img src="/images/call.svg" alt="Call icon" className="mr-[20px] md:w-[46px] w-[36px]" /> (747) 200-7091
                            </Link>
                            <Link
                                to="https://maps.app.goo.gl/jQK5Za39k5DuLiAV8"
                                target="_blank"
            ...
            <div className="pb-[230px] md:pb-[400px] lg:pb-[40px] xl:pb-[77px]">
                <Container>
                    <iframe
