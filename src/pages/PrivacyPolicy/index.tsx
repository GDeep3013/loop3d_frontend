    ...
    return (
        <>
            ...
            <div className="inner-page lg:py-[80px] pt-12 pb-[270px] md:pb-[390px]">
                <Container>
                    <h2 className="text-black text-[29px] md:text-[32px] lg:text-[42px] font-frank">Who we are</h2>
                    ...
                    <h2 className="text-black text-[29px] md:text-[32px] lg:text-[42px] font-frank">Embedded content from other websites</h2>
                    ...
                    <h2 className="text-black text-[29px] md:text-[32px] lg:text-[42px] font-frank">Who we share your data with</h2>
                    ...
                    <h2 className="text-black text-[29px] md:text-[32px] lg:text-[42px] font-frank">How long we retain your data</h2>
                    <p className="text-sm md:text-base leading-[29px] text-black font-poppins mt-2"><b className="bold">Suggested text:</b> Articles on this site may include embedded content (e.g. videos, images, articles, etc.). Embedded content from other websites behaves in the exact same way as if the visitor has visited the other website.</p>
                    ...
                    <h2 className="text-black text-[29px] md:text-[32px] lg:text-[42px] font-frank">What rights you have over your data</h2>
                    <p className="text-sm md:text-base leading-[29px] text-black font-poppins mt-2"><b className="bold">Suggested text:</b>  Articles on this site may include embedded content (e.g. videos, images, articles, etc.). Embedded content from other websites behaves in the exact same way as if the visitor has visited the other website.</p>

                    <h2 className="text-black text-[29px] md:text-[32px] lg:text-[42px] font-frank">Where your data is sent</h2>
                    ...
                    <h2 className="text-black text-[29px] md:text-[32px] lg:text-[42px] font-frank">Contact Us</h2>
