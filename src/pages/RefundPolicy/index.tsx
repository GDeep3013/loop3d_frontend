    ...
    return (
        <>
            ...
            <div className="inner-page lg:py-[80px] pt-12 pb-[270px] md:pb-[390px]">
                <Container>
                    <h2 className="text-black text-[29px] md:text-[32px] lg:text-[42px] font-frank">Refund and Returns Policy</h2>
                    <p className="text-sm md:text-base leading-[29px] text-black font-poppins mt-3">Last updated: July 23, 2024</p>

                    <h2 className="text-black text-[29px] md:text-[32px] lg:text-[42px] font-frank mt-3">Overview</h2>
                    ...
                    <h2 className="text-black text-[29px] md:text-[32px] lg:text-[42px] font-frank mt-3">Refunds</h2>
                    ...
                    <h2 className="text-black text-[29px] md:text-[32px] lg:text-[42px] font-frank mt-3">Exchanges</h2>
                    ...
                    <h2 className="text-black text-[29px] md:text-[32px] lg:text-[42px] font-frank mt-3">Gifts</h2>
                    ...
                    <h2 className="text-black text-[29px] md:text-[32px] lg:text-[42px] font-frank mt-3">Shipping returns</h2>
                    ...
                    <h2 className="text-black text-[29px] md:text-[32px] lg:text-[42px] font-frank mt-3">Need help?</h2>
